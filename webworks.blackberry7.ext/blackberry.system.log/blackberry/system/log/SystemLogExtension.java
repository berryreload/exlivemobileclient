...
{
    private String      FEATURE_SYSTEM_DISPLAY  = "blackberry.system.log";
    ...
    public void loadFeature(String feature, String version, Document doc, ScriptEngine scriptEngine) throws Exception
    {
        ...
        {
        	//Jiang: scriptEngine for call back BlackBerry Browser JavaScript
            scriptEngine.addExtension(FEATURE_SYSTEM_DISPLAY, new SystemLogNamespace(scriptEngine));
        }
    }
